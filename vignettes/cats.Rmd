...
This vignette examines the cats data set. The goal of this analysis is to see the effect sex has on the body and heart weight measures. This analysis goes further than that in the purify vignette by adding cross-validation to the summary function. This comes at the cost of computational time.
```{r setup}
library(purify)
library(ggplot2)
...
ggplot() +
  geom_point(aes(x = Bwt, y = Hwt, col = Sex, shape = Sex), data = cats, size = 8) +
  theme_bw() +
  theme(
