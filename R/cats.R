...
#'   ...
#' }
#' @source Fisher, R.A. (1947). The analysis of covariance method for the relation between a part and the whole. Biometrics, 3 2, 65-8.
...
#'
#' A subset of cats. The heart and body weights of samples of male and female cats used for digitalis experiments. The cats were all adult, over 2 kg body weight.
#'
#' @format ## `cats`
#' A data frame with 144 rows and 3 columns:
#' \describe{
